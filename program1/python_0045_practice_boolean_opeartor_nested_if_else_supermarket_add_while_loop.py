...
# -----------------------------------------------------------------------------------------
# In the below section: change all variable total_price to total_price_for_all_products.
# -----------------------------------------------------------------------------------------
...
if member_str == 'Y' or member_str == 'y' or member_str == 'Yes' or member_str == 'yes':
    total_price_for_all_products *= 0.9 # total_price = total_price * 0.9
...
if payment == 'Visa' or payment == 'Mastercard':
    ...
    if total_paid > total_price_for_all_products:
        ...
        print(f"You are still short of ${total_price_for_all_products - total_paid}. I am sorry, I cannot give you {product_name}")
    else:
